...
//////////////////////////////////////////////////////////////////
    ...
    if(net.train && l.layer_quant_flag){
        ...
        if(l.count == 0 || (l.count > 1 && net.layers[l.count-1].type == ROUTE)){
    ...
    for(i = 0; i < l.batch; ++i){
        for(j = 0; j < l.groups; ++j){
            ...
            if(net.delta_gpu) {
                ...
                // // if(l.count == 13){
                // //     printf("%d net.delta = %f\n", l.count, net.delta[10]);
                // // }else{
                // int num = 0, num_l = 0;
...
void update_convolutional_layer_gpu(layer l, update_args a)
{
    ...
    if(l.scales_gpu){
        ...
        printf("%d net.delta = %d, value = %f, update = %f\n", l.count, num, l.scales[0], l.scale_updates[0]);
    }
}
